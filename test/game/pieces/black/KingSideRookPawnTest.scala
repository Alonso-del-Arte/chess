...
class KingSideRookPawnTest {

  @Test def testAffiliation(): Unit = {
    println("affiliation")
    assertEquals(Black, KingSideRookPawn.affiliation)
  }
  ...
  @Test def testPossibleMoves(): Unit = {
    ...
    val actual = KingSideRookPawn.possibleMoves
  ...
  @Test def testCanJumpOver(): Unit = {
    ...
    assert(!KingSideRookPawn.canJumpOver, msg)
  }

  @Test def testCaptureSameAsMove(): Unit = {
    println("captureSameAsMove")
    val msg = "Pawn shouldn't capture same as move"
    assert(!KingSideRookPawn.captureSameAsMove, msg)
  }
  ...
  @Test def testPossibleCaptures(): Unit = {
    ...
    val actual = KingSideRookPawn.possibleCaptures
    assertEquals(expected, actual)
  }
  ...
  @Test def testHasSpecialMoves(): Unit = {
    ...
    assert(KingSideRookPawn.hasSpecialMoves, msg)
  }
