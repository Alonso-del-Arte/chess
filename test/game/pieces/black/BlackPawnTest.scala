...
class BlackPawnTest {
  ...
  @Test def testAffiliation(): Unit = {
    println("affiliation")
    assertEquals(Black, BlackPawnImpl.affiliation)
  }
  ...
  @Test def testPossibleMoves(): Unit = {
    ...
    val actual = BlackPawnImpl.possibleMoves
  ...
  @Test def testCanJumpOver(): Unit = {
    ...
    assert(!BlackPawnImpl.canJumpOver, msg)
  }

  @Test def testCaptureSameAsMove(): Unit = {
    println("captureSameAsMove")
    val msg = "Pawn shouldn't capture same as move"
    assert(!BlackPawnImpl.captureSameAsMove, msg)
  }
  ...
  @Test def testPossibleCaptures(): Unit = {
    ...
    val actual = BlackPawnImpl.possibleCaptures
    assertEquals(expected, actual)
  }
