...
class QueenSideBishopPawnTest {

  @Test def testAffiliation(): Unit = {
    println("affiliation")
    assertEquals(White, QueenSideBishopPawn.affiliation)
  }
  ...
  @Test def testPossibleMoves(): Unit = {
    ...
    val actual = QueenSideBishopPawn.possibleMoves
  ...
  @Test def testCanJumpOver(): Unit = {
    ...
    assert(!QueenSideBishopPawn.canJumpOver, msg)
  }

  @Test def testCaptureSameAsMove(): Unit = {
    println("captureSameAsMove")
    val msg = "Pawn shouldn't capture same as move"
    assert(!QueenSideBishopPawn.captureSameAsMove, msg)
  }
  ...
  @Test def testPossibleCaptures(): Unit = {
    ...
    val actual = QueenSideBishopPawn.possibleCaptures
    assertEquals(expected, actual)
  }
  ...
  @Test def testHasSpecialMoves(): Unit = {
    ...
    assert(QueenSideBishopPawn.hasSpecialMoves, msg)
  }
