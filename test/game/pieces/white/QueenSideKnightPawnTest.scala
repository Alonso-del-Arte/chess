...
class QueenSideKnightPawnTest {

  @Test def testAffiliation(): Unit = {
    println("affiliation")
    assertEquals(White, QueenSideKnightPawn.affiliation)
  }
  ...
  @Test def testPossibleMoves(): Unit = {
    ...
    val actual = QueenSideKnightPawn.possibleMoves
  ...
  @Test def testCanJumpOver(): Unit = {
    ...
    assert(!QueenSideKnightPawn.canJumpOver, msg)
  }

  @Test def testCaptureSameAsMove(): Unit = {
    println("captureSameAsMove")
    val msg = "Pawn shouldn't capture same as move"
    assert(!QueenSideKnightPawn.captureSameAsMove, msg)
  }
  ...
  @Test def testPossibleCaptures(): Unit = {
    ...
    val actual = QueenSideKnightPawn.possibleCaptures
    assertEquals(expected, actual)
  }
  ...
  @Test def testHasSpecialMoves(): Unit = {
    ...
    assert(QueenSideKnightPawn.hasSpecialMoves, msg)
  }
