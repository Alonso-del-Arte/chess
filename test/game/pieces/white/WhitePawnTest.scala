...
class WhitePawnTest {
  ...
  @Test def testAffiliation(): Unit = {
    println("affiliation")
    assertEquals(White, WhitePawnImpl.affiliation)
  }
  ...
  @Test def testPossibleMoves(): Unit = {
    ...
    val actual = WhitePawnImpl.possibleMoves
  ...
  @Test def testCanJumpOver(): Unit = {
    ...
    assert(!WhitePawnImpl.canJumpOver, msg)
  }

  @Test def testCaptureSameAsMove(): Unit = {
    println("captureSameAsMove")
    val msg = "Pawn shouldn't capture same as move"
    assert(!WhitePawnImpl.captureSameAsMove, msg)
  }
  ...
  @Test def testPossibleCaptures(): Unit = {
    ...
    val actual = WhitePawnImpl.possibleCaptures
    assertEquals(expected, actual)
  }
