...
class HorsesPawnTest {
  ...
  @Test def testAffiliation(): Unit = {
    println("affiliation")
    assertEquals(DarkGray, HorsesPawn.affiliation)
  }
  ...
  @Test def testPossibleMoves(): Unit = {
    ...
    val actual = HorsesPawn.possibleMoves
  ...
  @Test def testCaptureSameAsMove(): Unit = {
    ...
    assert(!HorsesPawn.captureSameAsMove, msg)
  }
  ...
  @Test def testPossibleCaptures(): Unit = {
    ...
    val actual = HorsesPawn.possibleCaptures
    assertEquals(expected, actual)
  }
  ...
  @Test def testHasSpecialMoves(): Unit = {
    ...
    assert(HorsesPawn.hasSpecialMoves, msg)
  }
