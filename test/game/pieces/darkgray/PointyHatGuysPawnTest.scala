...
class PointyHatGuysPawnTest {
  ...
  @Test def testPossibleMoves(): Unit = {
    ...
    val actual = PointyHatGuysPawn.possibleMoves
  ...
  @Test def testCanJumpOver(): Unit = {
    ...
    assert(!PointyHatGuysPawn.canJumpOver, msg)
  }

  @Test def testCaptureSameAsMove(): Unit = {
    println("captureSameAsMove")
    val msg = "Pawn shouldn't capture same as move"
    assert(!PointyHatGuysPawn.captureSameAsMove, msg)
  }
  ...
  @Test def testPossibleCaptures(): Unit = {
    ...
    val actual = PointyHatGuysPawn.possibleCaptures
    assertEquals(expected, actual)
  }
  ...
  @Test def testHasSpecialMoves(): Unit = {
    ...
    assert(PointyHatGuysPawn.hasSpecialMoves, msg)
  }
