...
object InitialBoardState extends BoardState(RegularBoard, White,
  Map(/* new RegularPosition(1, 1) -> game.pieces.white.QueenSideRook,
    ...
    new RegularPosition(1, 7) -> game.pieces.white.QueenSideRookPawn,
    new RegularPosition(2, 7) -> game.pieces.white.QueenSideKnightPawn,
    new RegularPosition(3, 7) -> game.pieces.white.QueenSideBishopPawn,
    new RegularPosition(4, 7) -> game.pieces.white.QueenPawn,
    new RegularPosition(5, 7) -> game.pieces.white.KingPawn,
    new RegularPosition(6, 7) -> game.pieces.white.KingSideBishopPawn,
    new RegularPosition(7, 7) -> game.pieces.white.KingSideKnightPawn,
    new RegularPosition(8, 7) -> game.pieces.white.KingSideRookPawn,
    new RegularPosition(1, 8) -> game.pieces.white.QueenSideRook,
    new RegularPosition(2, 8) -> game.pieces.white.QueenSideKnight,
    new RegularPosition(3, 8) -> game.pieces.white.QueenSideBishop,
    new RegularPosition(4, 8) -> game.pieces.white.Queen,
    new RegularPosition(5, 8) -> game.pieces.white.King,
    new RegularPosition(6, 8) -> game.pieces.white.KingSideBishop,
    new RegularPosition(7, 8) -> game.pieces.white.KingSideKnight,
    new RegularPosition(8, 8) -> game.pieces.white.KingSideRook */),
